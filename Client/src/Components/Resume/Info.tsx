...
const Info: React.FC<InfoProps> = ({
  photourl, setphotourl, name, setname, subtitle, setsubtitle, userdesc, setuserdesc,
  email, setemail, contact, setcontact, address, setaddress, github, setgithub, linkedin, setlinkedin, portfolio, setportfolio
}) => {
  return (
    <div>
      <div className="form">
        ...
        <div className="form">
          ...
          <div className="input-box">
            ...
            <input type="text" placeholder="Your Subtitle" value={subtitle} onChange={e => setsubtitle(e.target.value)} />
          </div>
          <div className="input-box textarea">
            <span className="details">Description</span>
            <textarea placeholder="Description" value={userdesc} onChange={e => setuserdesc(e.target.value)} />
          </div>
        </div>
